...
const About = ({ darkMode = false }) => {
  ...
  const sectionExp = about.sectionTitles?.experience[lang] || about.sectionTitles?.experience.en;
              ...
              {portfolioData.experience?.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`group grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-t transition-colors duration-300 ${
                      darkMode
                    ...
                    <div className="md:col-span-3">
                      <span
                        className={`font-mono text-xs uppercase tracking-wider block ${
                          darkMode ? "text-neutral-500" : "text-neutral-400"
                        }`}>
                        {item.period}
                      </span>
                      {item.link ? (
                        <a
                          ...
                          className={`text-xs font-semibold uppercase tracking-wider mt-1 inline-flex items-center gap-1 hover:underline ${
                      ...
                      {item.skills && (
                        <div className="flex flex-wrap gap-2 mt-4">
                          {item.skills.map((skill, sIdx) => (
                            <span
                              key={sIdx}
                              className={`text-[11px] font-mono uppercase px-2.5 py-1 border transition-colors ${
                                darkMode
                                  ? "border-white/10 text-neutral-400 group-hover:border-white/20 group-hover:text-neutral-200"
                                  : "border-black/10 text-neutral-600 group-hover:border-black/20 group-hover:text-black"
                              }`}>
                              {skill}
                            </span>
                          ))}
